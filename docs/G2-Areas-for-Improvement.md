...
## Station A Aligner Disabled by Missing Enable Signal [Daphne]
...
![code1](assets/g2-report/code1.png)

Hough Circle Transform Node (Station A) Part 1

![code2](assets/g2-report/code2.png)
